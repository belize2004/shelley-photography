import {getInteriorDesign, inte} from '@/lib/api/categories'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    images: ['https://i.ibb.co/qJG7W4R/int-og.png']
  }
}

export default async function Page() {
  // const queryClient = getQueryClient()
  const interiorDesigns = await getInteriorDesign()
  ...
  return (
    <div className="p-4">
      ...
      <PageClient isMobile={isMobile} interiorDesigns={interiorDesigns} />
      {/* </HydrationBoundary> */}
    </div>
  )
}
